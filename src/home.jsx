...
const Home = () => {
    return (
        ...
        <div className="half-container">
          ...
          <p className="subtitle">The jack of all trades and Master of Web Development. A designer who loves diving deep into problem solving and an engineer by heart.
          </p>
          <Link to="/about">
